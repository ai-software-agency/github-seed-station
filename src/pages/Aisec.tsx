            ...
            <div className="lg:col-span-2 rounded-xl border border-border bg-card p-6 flex flex-col justify-between h-full">
              ...
              <div className="space-y-3">
                ...
                <Button asChild variant="outline" size="lg" className="w-full justify-start gap-3">
                  <a href="#replit">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M5.23 7.13A7.504 7.504 0 0 1 12 4.5a7.504 7.504 0 0 1 6.77 2.63l-4.02 4.02A2.503 2.503 0 0 0 12 9.5a2.5 2.5 0 0 0-2.75 1.65l-4.02-4.02z"/>
                      <path d="M12 14.5a2.5 2.5 0 0 0 2.75-1.65l4.02 4.02A7.504 7.504 0 0 1 12 19.5a7.504 7.504 0 0 1-6.77-2.63l4.02-4.02A2.503 2.503 0 0 0 12 14.5z"/>
                    </svg>
